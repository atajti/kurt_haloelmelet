...
```{r "csomagbetöltés és königsbergi hidak", message=FALSE, warning=FALSE, paged.print=FALSE, fig.cap="Königsberg látképe az 1700-as években, a hidak zölddel kiemelve."}
data(Koenigsberg)
plot(Koenigsberg,
...
```{r 'teljes gráf', fig.cap='teljes gráf'}
...
```{r 'fa gráf', fig.cap = 'Egyszerű fa gráf'}
fa <- make_tree(5)
plot(fa, main="Fa")
summary(fa)
```
