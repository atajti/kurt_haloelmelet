...
```{r "csomagbetöltés és königsbergi hidak", echo=, message=FALSE, warning=FALSE, paged.print=FALSE, fig.cap="Königsberg látképe az 1700-as években, a hidak zölddel kiemelve."}
data(Koenigsberg)
plot(Koenigsberg,
